...
const Admin = () => {
  return (
    ...
    <div className="top mb-5 px-5 mt-5">
        <div className=" bg-blue-100 py-5 border border-black-100 rounded-lg">
    ...
    <div className="px-5">
        ...
        <div className="mid mb-5">
            ...
            <div className=" bg-blue-50 py-5 rounded-xl border border-blue-100">
                ...
                {/* text  */}
                <div className="">
                    <h1 className=" text-center text-lg text-black"><span className=" font-bold">Name :</span>Vikrant Mainwal</h1>
        ...
        <div className="">
            <div className="flex flex-wrap -m-4 text-center justify-center">
                ...
                <div className="p-4 md:w-1/3 sm:w-1/2 w-full cursor-pointer">
                    <div className=" border bg-red-50 hover:bg-blue-100 border-black-100 px-4 py-3 rounded-xl" >
                        ...
                        <h2 className="title-font font-medium text-3xl text-black-400 fonts1" >50</h2>

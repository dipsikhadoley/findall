...
const Login = () => {
    return (
        <div className='flex justify-center items-center h-screen'>
            {/* Login Form  */}
            <div className="login_Form bg-blue-300 px-1 lg:px-8 py-6 border border-blue-100 rounded-xl shadow-md">
                {/* Top Heading  */}
                <div className="mb-5">
                ...
                <div className="mb-5">
                    <button
                        type='button'
                        className='bg-purple-500 hover: bg-black-600 w-full text-white text-center py-2 font-bold rounded-md '
                    >
                    </button>
                </div>
                <div>
